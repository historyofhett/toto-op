  ...
  execute: async (message, args, client, prefix) => {
    try {
      ...
      const homeEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `_<:stolen_emoji:1201841280577970176> <a:Playing:1188088755819663400> **Check** [More Bots!](https://discord.gg/tdf6f2KZ27)\n` +
      ...
      const teamEmbed = new EmbedBuilder()
        ...
        .setDescription(
          `> **\`.01\` ${client.emoji.dot} Bot Developer** [Toto](https://discord.com/users/803285289358983199)\n` +
            `> **\`.02\` ${client.emoji.dot} Owner** [Het](https://discord.com/users/937253889252675696)\n`
        )
        .setColor("#5865F2")
        .setImage(client.config.links.arrkiii)
